 ...
 */
final class Version20240709080054 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE games (id INT AUTO_INCREMENT NOT NULL, white_user_id INT DEFAULT NULL, black_user_id INT DEFAULT NULL, winner_id INT DEFAULT NULL, table_data JSON NOT NULL, room_id VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, strategy_id SMALLINT NOT NULL, INDEX IDX_FF232B319266829D (white_user_id), INDEX IDX_FF232B318F3B0C6D (black_user_id), INDEX IDX_FF232B315DFCD4B8 (winner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE logs (id INT AUTO_INCREMENT NOT NULL, channel VARCHAR(255) NOT NULL, level VARCHAR(255) NOT NULL, message LONGTEXT NOT NULL, time DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
